    ...
    if (isLoading) {
        return (
            <header className="flex justify-between items-center py-4 px-4 sm:px-6 lg:px-8 bg-gray-800 text-white">
                ...
                <h1 className="text-xl sm:text-2xl lg:text-3xl font-black bg-clip-text text-transparent bg-linear-to-r from-blue-400 via-indigo-400 to-purple-500"><span className="font-bold ">T</span>ask Manager</h1>
                </div>
            </header>
        );
    }
